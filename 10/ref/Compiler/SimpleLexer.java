...
public class SimpleLexer {
    ...
    public static void main(String args[]) {
        ...
        String contents = readUsingFiles("/Users/mac/work/nand2everything/10/test/ArrayTest/Main.jack");
        SimpleLexer lexer = new SimpleLexer();
        
        Pattern p = Pattern.compile("/\\*{1,2}[\\s\\S]*?\\*/");
        Matcher m = p.matcher(contents);
        String sourConString = m.replaceAll("");

        p = Pattern.compile("//[\\s\\S]*?\\n");
        m = p.matcher(sourConString);
        sourConString = m.replaceAll("");

        System.out.println(sourConString);
    
        SimpleTokenReader tokenReader = lexer.tokenize(sourConString);
        dump(tokenReader);
    }
